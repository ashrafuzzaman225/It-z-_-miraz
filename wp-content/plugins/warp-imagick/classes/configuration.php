...
',
			...
			array(
				...
				'content' =>
				'
<h2>Limit maximum image size on upload.</h2>
<p>When enabled, JPEG/PNG images larger than maximum width (or height) will be reduced/downsized on upload.</p>
		...
		'webp-image-options'          => array(
			...
			'fields' => array(
				...
				'webp-compression-quality'      => array(
					...
					'title'   => sprintf( __( 'Applies to WebP image clones when converted from PNG & JPEG images. This value can be overridden when converting from JPEG (see JPEG to WebP compression quality below). This is a Lossy Compression. Default value is %s. Default cwebp value is 75. Max value to pass Google Page Speed Test is 75+10%% (about 82%%).', 'warp-imagick' ), Shared::webp_quality_default() ),
					'options' => array(
		...
		'upload-actions-section'      => array(
			...
			'fields' => array(
				...
				'image-max-width-pixels'  => array(
					...
					'title'   => __( 'Maximum image width limit in pixels. Images wider than maximum width limit and/or taller than 2500 pixels will be proportionally downsized to best fit maximum width given here and to maximum height of 2500 pixels. Downsized image will become new "original" and save your disk space. When image upload post processing fails, WordPress suggests to upload image sizes up to 2500 pixels. Default value is 2500 pixels.', 'warp-imagick' ),
					'options' => array(
