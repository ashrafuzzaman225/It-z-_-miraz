...
if ( ! class_exists( __NAMESPACE__ . '\Settings_Renderer' ) ) {
	...
	final class Settings_Renderer extends Meta_Settings_Renderer {
		...
		public function render_page_subtitle() {
			...
			echo '<div>' . esc_html( __( 'To apply settings to previously uploaded JPEG/PNG media, use ', 'warp-imagick' ) ) . '<a target=_blank rel="noopener noreferrer" href=https://wordpress.org/plugins/regenerate-thumbnails>"Regenerate Thumbnails" plugin</a></div>';

			if ( ! class_exists( '\\RegenerateThumbnails' ) ) {
				echo '<div><a href="/wp-admin/plugin-install.php?s=regenerate thumbnails&tab=search&type=term">' . esc_html( __( 'Click here to find, install and/or activate "Regenerate Thumbnails" plugin.', 'warp-imagick' ) ) . '</a></div>';
			}
