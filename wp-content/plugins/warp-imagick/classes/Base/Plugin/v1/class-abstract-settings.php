...
if ( ! class_exists( __NAMESPACE__ . '\Abstract_Settings' ) ) {
	...
	# region Activation requirements, activate, deactivate, uninstall
		 ...
		 * @return void
		 */
		final public function on_user_activate_plugin( $networkwide ) {
		 ...
		 * @return void
		 */
		final public function on_abstract_activate_plugin( $networkwide, $user = false ) {
		 ...
		 * @return void
		 */
		final public function on_user_deactivate_plugin( $networkwide ) {
		 ...
		 * @return void
		 */
		final public static function on_user_uninstall_plugin() {
