...
Contributors: ddur, pagespeedclub
License: GPLv2
Requires PHP: 5.6
Tested up to: 5.9
Stable tag: 1.9
Requires at least: 5.3
Tags: image optimization, optimize images, compress images, convert webp, sharpen
Donate link: https://login.wordpress.org/?redirect_to=https%3A%2F%2Fwordpress.org%2Fsupport%2Fplugin%2Fwarp-imagick%2Freviews%2F%3Ffilter%3D5%23new-post

No-cloud image optimization. Resize & Sharpen. Convert WebP. Optimize images to best quality/size image compression ratio. Disable big image threshold.

== Description ==

* **Warp iMagick Image Compressor is WordPress 5.8 WebP compatible!**
As this plugin handles only JPEG/PNG media types (+ convert to WebP), other media types upload (including new WebP) is handled by WordPress original code.
...
Choose your image compress quality from 30% to 95%. As recommended in video below, plugin default JPEG Compression Quality of 60% is good speed/quality compromise for most of the web sites. If not, choose your own best compression/quality settings. Sharpen Image from 0.5 to 1.5 Sigma. For the rest of the settings, use defaults [(some recommended by Google)](https://developers.google.com/speed/docs/insights/OptimizeImages#optimizations-for-gif,-png,-and-jpeg-images) or feel free to experiment and have fun with. 😇
...
Select WordPress Default or [sRGB*](https://developers.google.com/speed/docs/insights/OptimizeImages#optimizations-for-gif,-png,-and-jpeg-images). Default sRGB colorspace is a [**World Wide Web Standard**](https://www.w3.org/Graphics/Color/sRGB.html). [Lossless Color Compression]
...
* **Image Optimization**
[Search for Image Optimization](https://wordpress.org/plugins/search/image+optimization/)


* **Convert WebP**
[Search for Convert WebP](https://wordpress.org/plugins/search/convert+webp/)


* **Optimize Images**
[Search for Optimize Images](https://wordpress.org/plugins/search/optimize+images/)


* **Compress Images**
[Search for Compress Images](https://wordpress.org/plugins/search/compress-images/)


* **Image Optimizer**
[Search for Image Optimizer](https://wordpress.org/plugins/search/image+optimizer/)


* **Image Compressor**
[Search for Image Compressor](https://wordpress.org/plugins/search/image+compressor/)
...
1. EasyWP    : [Yes, documentation page provided](https://www.namecheap.com/support/knowledgebase/article.aspx/9697/2219/php-modules-and-extensions-on-shared-hosting-servers).
2. Hostpapa  : Yes, in cPanel. But may be not available in your hosting plan.
2. WPEngine  : Supposedly yes, but no web kb/help or documentation page found at the time of this version release.
3. DreamHost : Supposedly yes, but no web kb/help or documentation page found at the time of this version release.
4. A2 Hosting: Supposedly yes, but no web kb/help or documentation page found at the time of this version release.
5. Ask your host-service provider support.
...
* Recommend using [Htaccess File Editor](https://wordpress.org/plugins/wp-htaccess-editor/) to configure server to serve converted WebP clones and other plugin-help updates.
...
* [Changelog](https://plugins.trac.wordpress.org/browser/warp-imagick/trunk/changelog.txt).
