 ...
 * Add custom choice
 */
if ( ! function_exists( 'amela_add_custom_choice' ) ) {
	function amela_add_custom_choice() {
		return array(
			'fonts' => apply_filters( 'amela_kirki_font_choices', array() ),
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_base_font',
	'label'       => esc_html__( 'Base font', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
	...
	'choices'  => amela_add_custom_choice(),
	'output' => array(
		array(
...
// Kirki::add_field( 'amela_settings_config', array(
// 	'type'        => 'typography',
// 	'settings'    => 'amela_settings_secondary_font',
// 	'label'       => esc_html__( 'Secondary font', 'amela' ),
// 	'section'     => 'amela_settings_typography',
// 	'default'     => array(
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_headings_font',
	'label'       => esc_html__( 'Headings font', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-family'    => $heading_font,
		'font-weight' 	 => '500',
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_headings_h1',
	'label'       => esc_html__( 'H1 Headings', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-size'   	 => '42px',
		'text-transform' => 'none'
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_headings_h2',
	'label'       => esc_html__( 'H2 Headings', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-size'   	 => '34px',
		'text-transform' => 'none'
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_headings_h3',
	'label'       => esc_html__( 'H3 Headings', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-size'   	 => '28px',
		'text-transform' => 'none'
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_headings_h4',
	'label'       => esc_html__( 'H4 Headings', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-size'   	 => '24px',
		'text-transform' => 'none'
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_headings_h5',
	'label'       => esc_html__( 'H5 Headings', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-size'   	 => '20px',
		'text-transform' => 'none'
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_headings_h6',
	'label'       => esc_html__( 'H6 Headings', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-size'   	 => '16px',
		'text-transform' => 'none'
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_post_typography',
	'label'       => esc_html__( 'Post article text', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-size'      => '18px',
		'line-height'    => '1.8',
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_buttons_typography',
	'label'       => esc_html__( 'Buttons', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-family'    => $body_font,
		'font-weight'		 => '600',
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_menu_links_typography',
	'label'       => esc_html__( 'Menu links', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-family'    => $body_font,
		'font-weight' 	 => '600',
...
Kirki::add_field( 'amela_settings_config', array(
	'type'        => 'typography',
	'settings'    => 'amela_settings_dropdown_menu_links_typography',
	'label'       => esc_html__( 'Dropdown menu links', 'amela' ),
	'section'     => 'amela_settings_typography',
	'default'     => array(
		'font-family'    => $body_font,
		'variant' 			 => '400',
