...
(function () {
	...
	DEOTHEMES.initialize = {
		...
		offcanvasMiniCart: function () {
			const offcanvas = document.querySelectorAll(".amela-offcanvas-default");
			...
			trigger.forEach((item, i) => {
				const panel = offcanvas[i].querySelector(".amela-offcanvas__panel");
				const overlay = offcanvas[i].querySelector(".amela-offcanvas__overlay");
				const close = offcanvas[i].querySelector(".amela-offcanvas__close");
			...
			document.addEventListener("keydown", function (e) {
				...
				if (body.classList.contains("showing-modal")) {
					...
					if (body.classList.contains("showing-search-modal")) {
						let search = document.querySelectorAll(".amela-menu-search");

						for (var i = 0; i < search.length; i++) {
							firstEl = search[i].querySelector(".search-input");
							lastEl = search[i].querySelector(
		...
		menuSearch: function () {
			let search = document.querySelectorAll(
				".amela-menu-search:not(.eversor-menu-search)"
			);
			...
			for (var i = 0; i < search.length; i++) {
				let trigger = search[i].querySelector(".amela-menu-search__trigger"),
