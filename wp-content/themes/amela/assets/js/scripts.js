...
(function () {
  ...
  DEOTHEMES.initialize = {
    init: function init() {
      ...
      DEOTHEMES.initialize.offcanvasMiniCart();
    ...
    offcanvasMiniCart: function offcanvasMiniCart() {
      var offcanvas = document.querySelectorAll(".amela-offcanvas-default");

      if (0 === offcanvas.length) {
        return;
      }

      var trigger = document.querySelectorAll(".amela-offcanvas-js-trigger");
      trigger.forEach(function (item, i) {
        var panel = offcanvas[i].querySelector(".amela-offcanvas__panel");
        var overlay = offcanvas[i].querySelector(".amela-offcanvas__overlay");
        var close = offcanvas[i].querySelector(".amela-offcanvas__close");
      ...
      document.addEventListener("keydown", function (e) {
        ...
        if (body.classList.contains("showing-modal")) {
          ...
          if (body.classList.contains("showing-search-modal")) {
            var search = document.querySelectorAll(".amela-menu-search");

            for (var i = 0; i < search.length; i++) {
              firstEl = search[i].querySelector(".search-input");
              lastEl = search[i].querySelector(".amela-menu-search-modal__close");
    ...
    menuSearch: function menuSearch() {
      var search = document.querySelectorAll(".amela-menu-search:not(.eversor-menu-search)");
      ...
      var _loop = function _loop() {
        var trigger = search[i].querySelector(".amela-menu-search__trigger"),
            modal = search[i].querySelector(".amela-menu-search-modal"),
            inner = search[i].querySelector(".amela-menu-search-modal__inner"),
        ...
        trigger.addEventListener("click", function (e) {
          ...
          modal.classList.add("amela-menu-search-modal--is-open");
      ...
      function closeModal(modal) {
        ...
        modal.classList.remove("amela-menu-search-modal--is-open");
